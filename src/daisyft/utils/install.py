...
def get_component_docs(meta, docstring: str) -> tuple[str, str]:
    ...
    # For the class docstring, only use the brief part
    class_doc = brief_doc
    
    # For the file header, include everything
    if len(parts) > 1:
        detailed_doc = f'''"""Button Component
{meta.description}
...
"""'''
    ...
    for line in source.split('\n'):
        ...
        if any(x in line for x in ['@Registry', 'from ..base', 'from ..decorators', 'from daisyft', 'DETAILED_DOCS']):
            continue
